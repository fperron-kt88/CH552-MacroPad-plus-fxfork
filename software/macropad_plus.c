//
// TODO - Enlever le code par défaut pour éviter les ctrl-alt-delete ou les
// shutdown
// TODO - Comment utiliser le hold correctement?
// TODO - Refactoriser avec des pointeurs de fonction si la stack le permet.
// l'idée et d'aller vers DRY et SOLID
// TODO - Debugger les lumières
// TODO - Faire le vidéo?
//
// ===================================================================================
...
//   MacroPad to USB. All NeoPixels will light up white as long as the device is
//   in bootloader mode (about 10 seconds).
...
// ===================================================================================
// Macro Functions which associate Actions with Events (Customize your MacroPad
// here!)
// ===================================================================================
/*
    ...
    while (1) {
        ...
        if (!PIN_read(PIN_KEY1) != key1last) {  // key state changed?
            ...
            if (key1last) {                     // key was pressed?
                NEO_writeHue(
                    0, NEO_KEY1,
                    NEO_BRIGHT_KEYS);  // light up corresponding NeoPixel
        ...
        if (!PIN_read(PIN_ENC_A)) {     // encoder turned ?
            ...
            if (!isSwitchPressed &&
                !PIN_read(PIN_ENC_SW)) {  // switch previously pressed?
                ENC_SW_PRESSED();         // take proper action
                isSwitchPressed = 1;
            } else if (isSwitchPressed &&
                       PIN_read(PIN_ENC_SW)) {  // switch previously released?
